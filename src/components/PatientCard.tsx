...
export function PatientCard({ patient }: { patient: Patient }) {
  const { id, name, age, issue, issueColor, avatarSrc, address, phone, email } =
    patient;
  return (
    <div className="rounded-xl shadow-md bg-white border border-gray-100 overflow-hidden">
      <div className="flex items-center justify-between bg-blue-500/15 px-4 py-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="text-gray-600/80 text-sm">{id}</div>
