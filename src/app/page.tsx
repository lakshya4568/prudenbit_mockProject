      ...
      <section className="mx-auto max-w-7xl px-6 py-6 space-y-4">
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="inline-flex items-center gap-2 rounded border border-gray-300 px-4 py-2">
                option 1 <span>⇅</span>
              </button>
              <button className="inline-flex items-center gap-2 rounded border border-gray-300 px-4 py-2">
                option 1 <span>⇅</span>
        ...
        <div className="flex items-center gap-4">
          <div className="flex-1 relative rounded border border-gray-300 px-4 py-3">
            ...
            <input
              placeholder="Search"
              className="w-full pl-7 bg-transparent outline-none text-blue-500"
            />
          </div>
        ...
        <div className="flex flex-wrap gap-3">
          {Array.from({ length: 4 }, (_, i) => (
            <button
              key={i}
              className="inline-flex items-center gap-2 rounded border border-gray-300 px-6 py-2 text-sm"
            >
              Option {i + 1}
